...
namespace Microsoft.Build.Execution
{
    ...
    internal sealed class TaskRegistry : ITranslatable
    {
        ...
        /// </summary>
        private static readonly string s_tasksV4SimpleName = "Microsoft.Build.Tasks.v4.0";

        /// <summary>
        /// Filename for the MSBuild tasks (v4), used for shimming in loading
        /// task factory UsingTasks
        /// </summary>
        private static readonly string s_tasksV4Filename = s_tasksV4SimpleName + ".dll";
        ...
        /// task factory UsingTasks
        /// </summary>
        private static readonly string s_tasksV12SimpleName = "Microsoft.Build.Tasks.v12.0";

        /// <summary>
        /// Filename for the MSBuild tasks (v12), used for shimming in loading
        /// task factory UsingTasks
        /// </summary>
        private static readonly string s_tasksV12Filename = s_tasksV12SimpleName + ".dll";
        ...
        /// task factory UsingTasks
        /// </summary>
        private static readonly string s_tasksCoreSimpleName = "Microsoft.Build.Tasks.Core";

        /// <summary>
        /// Filename for the MSBuild tasks (v14+), used for shimming in loading
        /// task factory UsingTasks
        /// </summary>
        private static readonly string s_tasksCoreFilename = s_tasksCoreSimpleName + ".dll";
        ...
        internal class RegisteredTaskIdentity : ITranslatable
        {
            ...
            internal class RegisteredTaskIdentityComparer : IEqualityComparer<RegisteredTaskIdentity>
            {
                ...
                /// </summary>
                private readonly bool _exactMatchRequired;
